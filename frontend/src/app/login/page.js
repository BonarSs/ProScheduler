    ...
    <div>
      ...
      <div className="flex justify-center items-center h-screen mt-6 bg-gradient-to-br from-purple-100 via-blue-100 to-purple-100">
        <form onSubmit={submitLogin} className="max-w-lg w-full sm:w-[480px] mx-auto flex flex-col border border-violet-200 p-12 bg-gradient-to-br from-purple-100 via-blue-100 to-purple-100 shadow-2xl" style={{ borderRadius: '60px', fontFamily: 'Poppins', minWidth: '320px' }}>
          ...
          <p className='text-center mt-2 text-sm'>Don’t have an account?<a href="#" className="text-blue-700 hover:underline" onClick={toggleForm}> Register Now</a></p>
        </form>
      </div>
      ):(
      <div className="flex justify-center items-center h-screen mt-6 bg-gradient-to-br from-purple-100 via-blue-100 to-purple-100">
        <form className="max-w-lg w-full sm:w-[480px] mx-auto flex flex-col border border-violet-200 p-12 bg-gradient-to-br from-purple-100 via-blue-100 to-purple-100 shadow-2xl" style={{ borderRadius: '60px', fontFamily: 'Poppins', minWidth: '320px' }}>
          ...
          <p className='text-center mt-2 text-sm'>Already have account?<a href="#" className="text-blue-700 hover:underline" onClick={toggleForm}> Login</a></p>
        </form>
      </div>
    )}
