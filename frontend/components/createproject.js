        ...
        className="max-w-lg w-full sm:w-[480px] mx-auto flex flex-col border border-violet-200 p-12 bg-gradient-to-br from-purple-100 via-blue-100 to-purple-100 shadow-2xl" style={{ borderRadius: '60px', fontFamily: 'Poppins', minWidth: '320px' }}>
          ...
          <div className="mt-2">
            ...
            <input
              ...
              name='project_title'
              value={createProject.project_title}
            ...
            <div className="flex space-x-4 mt-1 w-80 mx-auto">
              <label className="inline-flex items-center">
                <input
                  ...
                  checked={createProject.project_category === 'app_development'}
                  onChange={handlechange}
                />
              ...
              <label className="inline-flex items-center">
                <input
                  ...
                  name="project_category"
                  value="event"
                  checked={createProject.project_category === 'event'}
                  onChange={handlechange}
                />
          ...
          <div className="mt-2">
            ...
            <input
              ...
              name='team_members'
              value={createProject.team_members}
              onChange={handlechange}
            />
          </div>
            ...
            <div className="flex space-x-4 mt-1">
              <div>
                ...
                <input
                  ...
                  name='start_date'
                  value={createProject.start_date}
                  onChange={handlechange}
                />
              </div>
              <div>
